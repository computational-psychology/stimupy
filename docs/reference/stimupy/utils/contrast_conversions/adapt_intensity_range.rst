...
.. py:function:: stimupy.utils.contrast_conversions.adapt_intensity_range(img, intensity_min=0.0, intensity_max=1.0)
   ...
   :returns: **img** -- image with adapted intensity range
   :rtype: np.ndarray
