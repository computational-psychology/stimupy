...
.. image:: /_static/generated_stimuli/components.radials.ring.png
...
.. centered:: You can find an interactive version of this example `here <../../../demos/components/radials/ring.html>`__





.. py:function:: stimupy.components.radials.ring(visual_size=None, ppd=None, shape=None, radii=None, intensity_ring=1.0, intensity_background=0.0, origin='mean')
