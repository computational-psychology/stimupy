...
.. image:: /_static/generated_stimuli/stimuli.waves.square_angular.png
   :alt: square_angular stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/waves/square_angular.html>`__





.. py:function:: stimupy.stimuli.waves.square_angular(visual_size=None, ppd=None, shape=None, frequency=None, n_segments=None, segment_width=None, period='ignore', rotation=0.0, phase_shift=0, intensity_segments=(0.0, 1.0), target_indices=(), intensity_target=0.5, origin='mean', round_phase_width=True)
