...
.. image:: /_static/generated_stimuli/stimuli.waves.sine_rectilinear.png
   :alt: sine_rectilinear stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/waves/sine_rectilinear.html>`__





.. py:function:: stimupy.stimuli.waves.sine_rectilinear(visual_size=None, ppd=None, shape=None, frequency=None, n_frames=None, frame_width=None, period='ignore', rotation=0.0, phase_shift=0, intensities=(0.0, 1.0), target_indices=(), intensity_target=0.5, origin='mean', round_phase_width=True, clip=False, intensity_background=0.5)
   ...
   :param frame_width: width of a single frame, in degrees
