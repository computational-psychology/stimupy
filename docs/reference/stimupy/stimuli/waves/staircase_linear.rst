...
.. image:: /_static/generated_stimuli/stimuli.waves.staircase_linear.png
   :alt: staircase_linear stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/waves/staircase_linear.html>`__





.. py:function:: stimupy.stimuli.waves.staircase_linear(visual_size=None, ppd=None, shape=None, frequency=None, n_bars=None, bar_width=None, period='ignore', rotation=0.0, phase_shift=0, intensity_bars=(0.0, 1.0), target_indices=(), intensity_target=0.5, origin='corner', round_phase_width=True)
   ...
   :param intensity_bars: min and max intensity of sine-wave, by default (0.0, 1.0).
                          Can also specify as many intensities as n_bars
   :type intensity_bars: Sequence[float, float] or Sequence[float, ...]
   ...
   :param intensity_bars: if len(intensity_bars)==2, intensity range of staircase (default 0.0, 1.0);
