...
.. image:: /_static/generated_stimuli/stimuli.waves.sine_linear.png
   :alt: sine_linear stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/waves/sine_linear.html>`__





.. py:function:: stimupy.stimuli.waves.sine_linear(visual_size=None, ppd=None, shape=None, frequency=None, n_bars=None, bar_width=None, period='ignore', rotation=0.0, phase_shift=0, intensities=(0.0, 1.0), target_indices=(), intensity_target=0.5, origin='corner', round_phase_width=True)
