...
.. image:: /_static/generated_stimuli/stimuli.waves.staircase_angular.png
   :alt: staircase_angular stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/waves/staircase_angular.html>`__





.. py:function:: stimupy.stimuli.waves.staircase_angular(visual_size=None, ppd=None, shape=None, frequency=None, n_segments=None, segment_width=None, period='ignore', rotation=0.0, phase_shift=0, intensity_segments=(0.0, 1.0), target_indices=(), intensity_target=0.5, origin='center', round_phase_width=True)
   ...
   :param frequency: spatial frequency of grating, in cycles per image
   :type frequency: Number, or None (default)
   :param n_segments: number of segments in the grating
   :type n_segments: int, or None (default)
   :param segment_width: width of a single segment, in degrees visual angle
   ...
   :param intensity_segments: if len(intensity_segments)==2, intensity range of staircase (default 0.0, 1.0);
   ...
   :param round_phase_width: if True, round width of segments given resolution
