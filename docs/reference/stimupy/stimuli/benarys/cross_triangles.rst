...
.. image:: /_static/generated_stimuli/stimuli.benarys.cross_triangles.png
   :alt: cross_triangles stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/benarys/cross_triangles.html>`__





.. py:function:: stimupy.stimuli.benarys.cross_triangles(visual_size=None, ppd=None, shape=None, cross_thickness=None, target_size=None, intensity_background=1.0, intensity_cross=0.0, intensity_target=0.5)
