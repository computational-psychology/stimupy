...
.. image:: /_static/generated_stimuli/stimuli.benarys.todorovic_generalized.png
   :alt: todorovic_generalized stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/benarys/todorovic_generalized.html>`__





.. py:function:: stimupy.stimuli.benarys.todorovic_generalized(visual_size=None, ppd=None, shape=None, L_width=None, target_size=None, target_type='r', target_rotation=0.0, target_x=None, target_y=None, intensity_background=1.0, intensity_cross=0.0, intensity_target=0.5)
