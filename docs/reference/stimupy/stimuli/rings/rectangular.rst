...
.. image:: /_static/generated_stimuli/stimuli.rings.rectangular.png
...
.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/rings/rectangular.html>`__





.. py:function:: stimupy.stimuli.rings.rectangular(visual_size=None, ppd=None, shape=None, frequency=None, n_frames=None, frame_width=None, period='ignore', rotation=0.0, phase_shift=0, intensity_frames=(0.0, 1.0), target_indices=(), intensity_target=0.5, origin='mean', round_phase_width=True, clip=False, intensity_background=0.5)
