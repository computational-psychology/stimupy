...
.. image:: /_static/generated_stimuli/stimuli.whites.white_two_rows.png
   :alt: white_two_rows stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/whites/white_two_rows.html>`__





.. py:function:: stimupy.stimuli.whites.white_two_rows(visual_size=None, ppd=None, shape=None, frequency=None, n_bars=None, bar_width=None, period='ignore', rotation=0.0, intensity_bars=(0.0, 1.0), intensity_target=0.5, target_indices_top=(), target_indices_bottom=(), target_center_offset=None, target_heights=None, origin='corner', round_phase_width=True)
