...
.. image:: /_static/generated_stimuli/papers.RHS2007.WE_circular1.png
   :alt: WE_circular1 stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.RHS2007.WE_circular1(ppd=PPD, pad=True)
