...
.. image:: /_static/generated_stimuli/papers.white1985.square_0phase.png
   :alt: square_0phase stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.white1985.square_0phase(ppd=PPD)
