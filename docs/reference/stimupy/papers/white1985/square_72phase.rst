...
.. image:: /_static/generated_stimuli/papers.white1985.square_72phase.png
   :alt: square_72phase stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.white1985.square_72phase(ppd=PPD)
