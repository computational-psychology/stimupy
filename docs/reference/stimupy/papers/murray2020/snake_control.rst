...
.. image:: /_static/generated_stimuli/papers.murray2020.snake_control.png
   :alt: snake_control stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.murray2020.snake_control(ppd=PPD)
