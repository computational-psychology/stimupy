...
.. image:: /_static/generated_stimuli/papers.murray2020.koffka_adelson.png
   :alt: koffka_adelson stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.murray2020.koffka_adelson(ppd=PPD)
