...
.. image:: /_static/generated_stimuli/papers.murray2020.simcon_articulated.png
   :alt: simcon_articulated stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.murray2020.simcon_articulated(ppd=PPD)
