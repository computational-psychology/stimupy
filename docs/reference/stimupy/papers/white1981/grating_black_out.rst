...
.. image:: /_static/generated_stimuli/papers.white1981.grating_black_out.png
   :alt: grating_black_out stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.white1981.grating_black_out(ppd=PPD)
