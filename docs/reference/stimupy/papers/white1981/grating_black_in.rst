...
.. image:: /_static/generated_stimuli/papers.white1981.grating_black_in.png
   :alt: grating_black_in stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.white1981.grating_black_in(ppd=PPD)
