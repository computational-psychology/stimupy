...
.. image:: /_static/generated_stimuli/papers.white1981.grating_white_in.png
   :alt: grating_white_in stimulus example
   :align: center
   :width: 400px
...
.. py:function:: stimupy.papers.white1981.grating_white_in(ppd=PPD)
