...
```{important}
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/computational-psychology/stimupy/dev_docs?urlpath=tree/docs/reference/demos/components/gratings.md)
...
## Gabor
{py:func}`stimupy.components.gratings.gabor`

```{code-cell} ipython3
from stimupy.components.gratings import gabor
