...
.. image:: /_static/generated_stimuli/stimuli.benarys.todorovic_triangles.png
   :alt: todorovic_triangles stimulus example
   :align: center
   :width: 400px



.. centered:: You can find an interactive version of this example `here <../../../demos/stimuli/benarys/todorovic_triangles.html>`__





.. py:function:: stimupy.stimuli.benarys.todorovic_triangles(visual_size=None, ppd=None, shape=None, L_width=None, target_size=None, intensity_background=1.0, intensity_cross=0.0, intensity_target=0.5)
   ...
   :param L_width: width of L in degree visual angle
   :type L_width: float
   :param target_size: size of adjacent and opposite of target triangle in degrees visual angle
