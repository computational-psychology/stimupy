...
.. image:: /_static/generated_stimuli/components.shapes.wedge.png
...
.. centered:: You can find an interactive version of this example `here <../../../demos/components/shapes/wedge.html>`__





.. py:function:: stimupy.components.shapes.wedge(visual_size=None, ppd=None, shape=None, angle=None, radius=None, rotation=0.0, inner_radius=0.0, intensity_wedge=1.0, intensity_background=0.0, origin='mean')
