...
.. image:: /_static/generated_stimuli/components.edges.gaussian.png
...
.. centered:: You can find an interactive version of this example `here <../../../demos/components/edges/gaussian.html>`__





.. py:function:: stimupy.components.edges.gaussian(visual_size=None, ppd=None, shape=None, sigma=None, rotation=0.0, intensity_edges=(0.0, 1.0), intensity_background=0.5)
