...
.. image:: /_static/generated_stimuli/components.edges.cornsweet.png
...
.. centered:: You can find an interactive version of this example `here <../../../demos/components/edges/cornsweet.html>`__





.. py:function:: stimupy.components.edges.cornsweet(visual_size=None, ppd=None, shape=None, ramp_width=None, rotation=0.0, intensity_edges=(0.0, 1.0), intensity_plateau=0.5, exponent=2.75)
