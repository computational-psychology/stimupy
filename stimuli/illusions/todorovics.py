...
from stimuli.utils import degrees_to_pixels, pad_dict_to_shape, resolution, stack_dicts
...
if __name__ == "__main__":
    ...
    stims = {
        ...
        "rectangle_general": rectangle_generalized(**p1, target_position=3.5, covers_x=(2, 6), covers_y=(2, 6)),
