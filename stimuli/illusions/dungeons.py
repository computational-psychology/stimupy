import numpy as np
from stimuli.utils import resolution, pad_to_shape
...
def resolve_dungeon_params(
    ...
    n_cells1, visual_angle1, cell_size1 = resolve_cells_1d(visual_size[0],
                                                           n_cells[0]-0.5,
                                                           cell_size[0])
    n_cells2, visual_angle2, cell_size2 = resolve_cells_1d(visual_size[1],
                                                           n_cells[1]-0.5,
                                                           cell_size[1])
