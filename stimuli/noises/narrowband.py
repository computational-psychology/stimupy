...
def narrowband(
    ...
    sigma = center_frequency / ((2.**bandwidth+1) * np.sqrt(2.*np.log(2.))) * (2.**bandwidth-1)
...
if __name__ == "__main__":
    ...
    stims = {
        "Narrowband noise - 3cpd": narrowband(center_frequency=3.),
        "Narrowband noise - 9cpd": narrowband(center_frequency=9.),
    }
